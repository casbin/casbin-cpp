    ...
    TEST_CLASS(TestRBACAPIWithDomains)
    {
        public:
            ...
            TEST_METHOD(TestUserAPIWithDomains) {
                shared_ptr<Enforcer> e = Enforcer::NewEnforcer("../../examples/rbac_with_domains_model.conf", "../../examples/rbac_with_domains_policy.csv");
            ...
            void TestGetPermissionsInDomain(shared_ptr<Enforcer> e, string name, string domain, vector<vector<string>> res) {
