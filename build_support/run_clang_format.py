...
def check(arguments, source_dir, style):
    formatted_filenames = []
    error = False
    format_args = [arguments.clang_format_binary, "--style=" + style]
